...
contract Ownable {
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(
            newOwner != address(0),
            "The owner address has to be an real address"
        );
...
contract ERC165 is Ownable {
    ...
    function setPauseToContract(bool value) public onlyOwner {
        _paused = value;
        if (value == true) emit Paused(msg.sender);
        if (value == false) emit Unpaused(msg.sender);
    }
    ...
    modifier paused() {
        require(_paused == true, "The contract isn't paused");
        _;
    }
    /**
...
contract ERC721 is ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != _tokenOwner[tokenId], "The address is already the owner");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(
            _isApprovedOrOwner(msg.sender, tokenId) == true,
            "The token isn't approved to send"
        );
    ...
    function _transferFrom(
        ...
        require(
            ...
            "Spender must be the owner to transfer."
        );
